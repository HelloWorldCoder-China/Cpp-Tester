...
import glob
print("C++测试器  HelloWorldCoder制作  你只拥有此软件的永久使用、复制权")
...
if optype=="1":
    ...
    if not pass_this:
        line_No=1
        flag=True
        while line_No<=lines or lines==0:
    ...
    for i in range(1,points+1):
        ...
        if run_file==1:
            ...
            os.system("cp {} {} && copy {} {}".format(comprogpath,path+"/testpoint"+str(i)+"/"+os.path.basename(comprogpath),comprogpath,path+"/testpoint"+str(i)+"/"+os.path.basename(comprogpath)))
            os.system("cp {} {} && copy {} {}".format(path+"/"+file_name.format(i)+".ans",path+"/testpoint"+str(i)+"/"+file_name.format("")+".ans",path+"/"+file_name.format(i)+".ans",path+"/testpoint"+str(i)+"/"+file_name.format("")+".ans"))
            os.system("cp {} {} && copy {} {}".format(path+"/"+file_name.format(i)+".in",path+"/testpoint"+str(i)+"/"+file_name.format("")+".in",path+"/"+file_name.format(i)+".in",path+"/testpoint"+str(i)+"/"+file_name.format("")+".in"))
